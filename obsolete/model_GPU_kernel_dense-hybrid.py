...
modelname = "kernel-25-hybrid".format(int(time.time()))
...
check = ModelCheckpoint("kernel-dense-hybrid{epoch:02d}-{val_loss:.5f}.h5", monitor='val_loss', verbose=0, save_best_only=False, save_weights_only=False, mode='auto', period=1)
